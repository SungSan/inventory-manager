-- Drop incorrect overload and ensure record_movement_v2 uses movements columns only
drop function if exists public.record_movement(text, text, text, uuid, text, text, text, text, text, integer);
