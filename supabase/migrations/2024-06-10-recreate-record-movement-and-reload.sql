-- Recreate record_movement with the expected signature and refresh PostgREST cache
...
-- Refresh PostgREST/Supabase schema cache so the new signature is visible immediately
